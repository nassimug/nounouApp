...
const contracts = [
  ...
  },
  {
    ...
    nannyAddress: "45 boulevard Saint-Michel, 75005 Paris",
    familyName: "Famille Dupont",
    familyAddress: "45 avenue Victor Hugo, 75016 Paris",
    startDate: "15/02/2025",
    endDate: "15/02/2026",
    childrenNames: ["Emma Dupont"],
    childrenAges: ["5 ans"],
    workSchedule: [
...
export default function ContractViewPage() {
  ...
  const handleDownloadPDF = async () => {
    await generatePDF("contract-content", `contrat-${contract.nannyName.replace(/ /g, "-")}`)
  }
      ...
      <main className="container mx-auto px-4 py-6 pb-20 md:pb-6">
        ...
        >
          <CardHeader className="border-b">
            <div className="flex justify-between items-center">
              <div className="flex items-center">
                ...
                <CardTitle className="text-xl text-[#FF80AB]">{contract.title}</CardTitle>
              </div>
              <div className="flex items-center">
                <span
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="border-t pt-4">
              <h3 className="font-medium text-[#FF80AB] mb-3">Période du contrat</h3>
            ...
            <div className="border-t pt-4">
              <h3 className="font-medium text-[#FF80AB] mb-3">Horaires de travail</h3>
              <div className="space-y-2">
            ...
            <div className="border-t pt-4">
              <h3 className="font-medium text-[#FF80AB] mb-3">Rémunération</h3>
            ...
            <div className="border-t pt-4">
              <h3 className="font-medium text-[#FF80AB] mb-3">Conditions particulières</h3>
              <p className="text-gray-700">{contract.additionalTerms}</p>
            </div>

            <div className="border-t pt-4">
              <h3 className="font-medium text-[#FF80AB] mb-3">Signatures</h3>
              <div className="flex justify-between py-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div className="p-4 border rounded-lg text-center">
                  ...
                  <div className="h-16 flex items-center justify-center">
                    <span className="text-[#FF80AB] italic">Famille Dupont</span>
                  </div>
                </div>
                <div className="p-4 border rounded-lg text-center">
