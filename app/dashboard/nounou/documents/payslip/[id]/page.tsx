...
export default function NannyPayslipViewPage() {
  ...
  const handleDownloadPDF = async () => {
    await generatePDF("nanny-payslip-content", `fiche-de-paie-${payslip.month.replace(/ /g, "-")}`)
  }
        ...
        >
          <CardHeader className="border-b">
            <div className="flex justify-between items-center">
              <div className="flex items-center">
                <FileText className="h-6 w-6 mr-2 text-[#4FC3F7]" />
                <CardTitle className="text-xl text-[#4FC3F7]">Fiche de paie - {payslip.month}</CardTitle>
              </div>
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="border-t pt-4">
              <h3 className="font-medium text-[#4FC3F7] mb-3">Détails de la rémunération</h3>
              <div className="space-y-2">
                ...
                <div className="flex justify-between py-2 font-bold text-lg">
                  ...
                  <div className="text-[#4FC3F7]">{payslip.totalNet}€</div>
                </div>
              </div>
            </div>
