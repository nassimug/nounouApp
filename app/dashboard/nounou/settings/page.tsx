  ...
  return (
    <div className="min-h-screen bg-[#E3F2FD]/30">
      ...
      <main className="container mx-auto px-4 py-6 pb-20 md:pb-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-[#4FC3F7]">Paramètres</h1>
          <p className="text-gray-600">Gérez vos préférences et la sécurité de votre compte</p>
        </div>

        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          <TabsList className="grid grid-cols-3 md:w-[400px]">
            <TabsTrigger value="account" className="data-[state=active]:bg-[#4FC3F7] data-[state=active]:text-white">
              Compte
            </TabsTrigger>
            <TabsTrigger value="security" className="data-[state=active]:bg-[#4FC3F7] data-[state=active]:text-white">
              Sécurité
            </TabsTrigger>
            <TabsTrigger
              value="notifications"
              className="data-[state=active]:bg-[#4FC3F7] data-[state=active]:text-white"
            >
              Notifications
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="account">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg text-[#4FC3F7]">Informations du compte</CardTitle>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="pt-4 space-y-4">
                    <Button type="submit" className="bg-[#4FC3F7] hover:bg-[#29B6F6] text-white" disabled={isLoading}>
                      {isLoading ? (
          ...
          <TabsContent value="security">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg text-[#4FC3F7]">Sécurité du compte</CardTitle>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
          ...
          <TabsContent value="notifications">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg text-[#4FC3F7]">Préférences de notifications</CardTitle>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-4">
                    <h3 className="font-medium flex items-center gap-2">
                      <Bell className="h-5 w-5 text-[#4FC3F7]" />
                      Notifications par email
                    </h3>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <Label htmlFor="emailNewRequest" className="flex-1">
                          Nouvelles demandes de garde
                        </Label>
                        <Switch id="emailNewRequest" defaultChecked />
                      </div>
                      <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center justify-between">
                        <Label htmlFor="emailPayslip" className="flex-1">
                          Nouvelles fiches de paie
                        </Label>
                        <Switch id="emailPayslip" defaultChecked />
                      </div>
                      <div className="flex items-center justify-between">
                  ...
                  <div className="space-y-4">
                    <h3 className="font-medium flex items-center gap-2">
                      <Smartphone className="h-5 w-5 text-[#4FC3F7]" />
                      Notifications push
                    </h3>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <Label htmlFor="pushNewRequest" className="flex-1">
                          Nouvelles demandes de garde
                        </Label>
                        <Switch id="pushNewRequest" defaultChecked />
                      </div>
                      <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center justify-between">
                        <Label htmlFor="pushPayslip" className="flex-1">
                          Nouvelles fiches de paie
                        </Label>
                        <Switch id="pushPayslip" />
                      </div>
                      <div className="flex items-center justify-between">
